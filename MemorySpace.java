...
public class MemorySpace {
     ...
     *
     * If the length of the found block is exactly the same as the requested
     * length, then the found block is removed from the freeList and appended to
     * the allocatedList.
     *
    ...
    /**
     * Frees the memory block whose base address equals the given address. This
     * implementation deletes the block whose base address equals the given
     ...
     * memory space, for debugging purposes.
     */
    ...
    /**
     * Performs defragmantation of this memory space. Normally, called by
     * malloc, when it fails to find a memory block of the requested size. In
     * this implementation Malloc does not call defrag.
     */
    public void defrag() {
        ListIterator iter = freeList.iterator();
